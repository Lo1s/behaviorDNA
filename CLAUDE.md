...
- [docs/ROADMAP.md](docs/ROADMAP.md) — roadmap + status: Phases 1–5 done, 6 done, 7 done (defender-favoured evasion frontier), 8 done (null result), 1.5 partial, 9 **spike done** (CS2 outcome telemetry + clock-sync feasible; execution awaits dual-capture data)
...
- `notebooks/01_*`–`07_*` foundational analysis · `10` adversarial bots · `12` explainability · `16` architecture deep-dive · `17` ID at scale (CS2) · `18` signal importance · `19` public-corpus ID/verification · `20` evasion frontier (Phase 7) · `21` self-supervised pretraining (Phase 8)
