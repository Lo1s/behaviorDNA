...
- [docs/ROADMAP.md](docs/ROADMAP.md) — roadmap + status: Phases 1–5 done, 6 done, 7 done (defender-favoured evasion frontier), 8 done (null result), 1.5 partial, 9 not started
